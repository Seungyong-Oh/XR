...
/// </summary>
[AddComponentMenu("XR/Action Based Controller2 Manager")]
[DefaultExecutionOrder(kControllerManagerUpdateOrder)]
public class ActionBasedController2Manager : MonoBehaviour
{
    ...
    public class ControllerState
    {
        ...
        StateId m_Id;
        /// <summary>
        /// Sets the identifier of the <see cref="ControllerState"/> from all the optional Controller States that the <see cref="ActionBasedController2Manager"/> holds.
        /// </summary>
        public StateId id
        {
            get => m_Id;
